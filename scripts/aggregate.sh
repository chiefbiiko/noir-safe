...
#NOTE https://github.com/AztecProtocol/aztec-packages/issues/1274
#  :: public_inputs aren't constrained in recursive proofs
#  :: the public inputs are the very first items within the proof array anyways
...
###
# https://github.com/AztecProtocol/aztec-packages/issues/1274
#     // public_inputs aren't constrained in recursive proofs anyways ¯\_(°ペ)_/¯ 
# aggregate
...
echo "sp_proof = $SP_FULL_PROOF_AS_FIELDS" >> $AGGREGATION_PROVER_TOML
# echo "sp_pi = $SP_PUBLIC_INPUTS" >> $AGGREGATION_PROVER_TOML
echo "sp_pi = []" >> $AGGREGATION_PROVER_TOML
# echo "ap_proof = $AP_PROOF_AS_FIELDS" >> $AGGREGATION_PROVER_TOML
echo "ap_proof = $AP_FULL_PROOF_AS_FIELDS" >> $AGGREGATION_PROVER_TOML
# echo "ap_pi = $AP_PUBLIC_INPUTS" >> $AGGREGATION_PROVER_TOML
echo "ap_pi = []" >> $AGGREGATION_PROVER_TOML
