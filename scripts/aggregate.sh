...
sp_shard() {
    $n execute --package noir_safe_storage_proof_circuit sp_witness
...
ap_shard() {
    $n execute --package noir_safe_account_proof_circuit ap_witness
...
an_shard() {
    $n execute --package noir_safe_anchor_circuit an_witness
...
ag_circuit() {
    $n execute --package noir_safe_aggregation_circuit ag_witness
